...
const SLUG_NOTES = {
  ...
  "el-secreto-inflamable-de-la-biznaga-cactus-que-curan-mas-alla-del-desierto":
    " Depict BIZNAGAS (Mexican barrel cacti, Ferocactus and Echinocactus): large round-to-cylindrical green cacti with prominent vertical ribs and clusters of long curved yellow-and-red spines along the ridges, some crowned with a circle of small pink or yellow flowers on top. In the foreground, an elderly Mexican curandero or campesino in white cotton clothes, huaraches and a wide straw hat kneels next to a biznaga, carefully slicing off a piece with a small knife to reveal the pale translucent gelatinous pulp inside; on a nearby stone he has a clay molcajete, a bundle of medicinal herbs and a folded cotton cloth ready to use the pulp as an anti-inflammatory poultice. Setting: an arid highland sierra of central Mexico (Hidalgo, San Luis Potosí or Querétaro) with rolling rocky hills, scattered magueys and nopales, dry yellow grass, and distant blue mountain ranges under a warm sky. ABSOLUTELY NO cityscape, NO urban skyline, NO buildings, NO skyscrapers, NO cars, NO color palette strips on any side, NO color swatch grid at the bottom, NO Pantone-style color blocks, NO color reference panels — only the natural sierra scene with the curandero and the biznagas filling the entire canvas edge to edge as one continuous illustration.",
